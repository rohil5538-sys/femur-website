            ...
            >
              <motion.div className="space-y-4" variants={itemVariants}>
                <h1 className="text-4xl font-heading font-bold tracking-tighter sm:text-5xl xl:text-7xl/none">
                  <span className="gradient-text">Professional Web & App</span>
                  <br />
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400 opacity-70">
                  Transform your ideas into powerful digital solutions. We specialize in custom website development,
                  mobile app creation, and UI/UX design that drives results for your business.
                </p>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="pt-4">
                <p className="text-sm text-muted-foreground flex items-center">
                  ...
                  Trust us to build your Ideas into Reality
                </p>
              </motion.div>
            </motion.div>
          </ScrollReveal>
            ...
            <SpotlightCard className="relative h-[450px] w-full overflow-hidden rounded-xl border glassmorphic-card p-1 border-glow-red">
              ...
              <div className="relative z-20 h-full w-full rounded-xl bg-gradient-to-br from-red-950/50 to-gray-950/50 p-6 flex items-center justify-center">
                <div className="grid grid-cols-2 gap-6 w-full max-w-md">
                  ...
                  >
                    <span className="font-heading text-xl text-white tracking-tight">Full-Stack Development</span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <span className="font-heading text-white tracking-tight">Web Apps</span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    whileHover={{ scale: 1.03, boxShadow: "0 0 15px rgba(220, 38, 38, 0.3)" }}
                  >
                    <Smartphone className="h-8 w-8 text-white mb-2" />
                    <span className="font-heading text-white tracking-tight">Mobile Apps</span>
                  </motion.div>
                </div>
              </div>
            </SpotlightCard>
